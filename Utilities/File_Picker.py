...
def main():
  #root_dir = os.path.expanduser('~/Documents/Pythonista_games/Word_Games')
  root_dir = None
  py_files = file_picker_dialog('Pick some .py files', root_dir = root_dir, multiple=True, select_dirs=False, file_pattern=r'^.*\.py$')
