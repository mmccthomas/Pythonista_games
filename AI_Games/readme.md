...
This is a set of games generated by google.gemeni.ai. and Claude Sonnet 4.6!!
...
Galaxians
---------
Generated by Claude Sonnet 4.6 with instuction
'This is the assembler code for the game of Galaxians.
Can you decode this and convert to Python?
 Use Pythonista to render graphics'
 
Converted graphics to SpriteNode since there appears to be 
a bug in scene.load_pil_image, which prevents drawing sprite
image in a scene_drawing environment.

Added Joystick interface for movement.

Entry point: AI_games/galaxians.py

<img src="../assets/Galaxians_asm.png" alt="App Screenshot" width="500">
...
Generated by Claude Sonnet 4.6 with instuction
"Find an assembly code version of the classic space invaders online. 
Then try to convert it to Python using Pythonista for rendering."
Changes made manually:

removed lines in blocks
move wave text  in hud
added sounds 
finish explosion in dead aliens

 
Entry point: AI_games/space_invaders_from_asm.py
<img src="../assets/Space Invaders.png" alt="App Screenshot" width="500">

Defender
--------
Generated by Claude Sonnet 4.6 with instuction
"Find an assembly code version of the classic game defender online. 
Then try to covert it to Python using Pythonista for rendering."
Claude generated some hallucinations with regard to scene_drawing 
functions
...
Entry point: AI_games/defender.py
<img src="../assets/Defender.png" alt="App Screenshot" width="500">

Asteroids
---------
Generated by Claude Sonnet 4.6 with instuction
"Find an assembly code version of the classic asteroids online.
Then try to covert it to Python using Pythonista for rendering."

only one small change made to ship coordinates to correct direction discrepancy

Entry point: AI_games/asteroids.py

<img src="../assets/Asteroids.png" alt="App Screenshot" width="500">

Final observations.
-------------------

AI systems have become VERY good at generating code to run in Pythonista.
Conversion of annotated assembler code is a very exciting development.
