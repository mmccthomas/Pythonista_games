...
def separate_irregular_sprites(sprite_sheet_path, 
    ...
    Args:
        ...
        use_alpha (bool): if True, use the alpha channel value
        sprite_names (list): if provided, list is flattened to pass back
        display (bool): if True, rects and image crops are listed
    """
    ...
    for bbox in bounding_boxes:
        ...
        if (width * height) < min_sprite_area:
            continue
        boxes[Rect(x_min, y_min, x_max, y_max)] = original_img.crop(bbox)
